...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-28 sm:pb-32 flex flex-col antialiased relative">
      ...
      {/* Sticky Bottom Navigation Bar - ALWAYS viewable on both mobile & desktop */}
      <div className="fixed bottom-0 left-0 right-0 bg-slate-950/95 backdrop-blur-md border-t border-slate-900/90 py-2 z-40 flex shadow-2xl justify-center">
